...
describe('PublicKey', function() {
  ...
  describe('#toAddress', function() {
    ...
    it('should output this known mainnet address correctly', function() {
      ...
      address.toString().should.equal('ESFpNbj2DS7vRY1CAh4QtMfyqb7ioqTzk6');
    });
    ...
    it('should output this known mainnet witness address correctly', function() {
      ...
      address.toString().should.equal('web1qv0t45lutg37ghyg7lg22vgducs3d9hvu98fu5c');
    });
    ...
    it('should output this known mainnet wrapped witness address correctly', function() {
      ...
      address.toString().should.equal('DDPVr4Zqi6hDpBradKHydGb9SFvUZpxFwN');
    });
  ...
  describe('hashes', function() {
    ...
    var data = [
      ['5HxWvvfubhXpYYpS3tJkw6fq9jE9j18THftkZjHHfmFiWtmAbrj', 'EgQkKwJiW2rQ2gu67Qt6KLrNYNqac6og6d'],
      ['5KC4ejrDjv152FGwP386VD1i2NYc5KkfSMyv1nGy1VGDxGHqVY3', 'EXEsZouknZNTyvujyzgracd1ouj5gKnp5U'],
      ['Kwr371tjA9u2rFSMZjTNun2PXXP3WPZu2afRHTcta6KxEUdm1vEw', 'EexDMPiPPLUEeVtm7NSaHicGdAvMbN4iB8'],
      ['L3Hq7a8FEQwJkW1M2GNKDW28546Vp5miewcCzSqUD9kCAXrJdS3g', 'EUadWsorS9pRyamP9FtEGUxeT1xGvJRnxv']
    ];
