...
describe('MultiSigScriptHashInput', function() {
  ...
  var address = new Address('D7SgMk2eK4DH3GMWztD4rpmm4STL9LqcVx');
  var witnessAddress = new Address([public1, public2, public3], 2, null, Address.PayToWitnessScriptHash);

  var output = {
    address: 'D7SgMk2eK4DH3GMWztD4rpmm4STL9LqcVx',
  ...
  var witnessOutput = {
    address: 'web1qd2kqrwpmz5m6lc42jmgn5vum3ggfkp0kateh6kzqle0jyldwmtxq0c8jwj',
    txId: '66e64ef8a3b384164b78453fa8c8194de9a473ba14f89485a0e433699daec140',
    outputIndex: 0,
