...
describe('Address', function() {
  ...
  var buf = Buffer.concat([Buffer.from([33]), pubkeyhash]);
  var str = 'ENeUGsmw8u99wyF948GFwzfC8Udd6RqTbP';
  ...
  // livenet valid
  var PKHLivenet = [
    'EN5f6uVd78JxvdmeNBm7W3LgV8ijPHPHBN',
    'ESFpNbj2DS7vRY1CAh4QtMfyqb7ioqTzk6',
    'ETyWKFB8y566RTHAvRD3h4LeceiXKhLDca',
    'Eb8wTnG8WPjvoLHLe6Abx1RNSHGBCrkqNf',
    '    Eb8wTnG8WPjvoLHLe6Abx1RNSHGBCrkqNf   \t\n'
  ];

  // livenet p2sh
  var P2SHLivenet = [
    'D7UkW9sQfksZeUjQoQK365QKaPfWqCFEqJ',
    'D7NxkDAUqFTkSqZKtEq4jNZuikoQivHewd',
    'DAtti9NFiaLQ4rGZcnp3woeCMDixmacSx4',
    'DUBd9QuxgRK3HE4gtwnUiDkQGK5T49FAkp',
    '\t \nDUBd9QuxgRK3HE4gtwnUiDkQGK5T49FAkp \r'
  ];
  ...
  var badChecksums = [
    'EN5f6uVd78JxvdmeNBm7W3LgV8ijPHPH2N',
    'ESFpNbj2DS7vRY1CAh4QtMfyqb7ioq22k6',
    'ETyWKFB8y566RTHAvRD3h4LeceiXKh3D33',
    'Eb8wTnG8WPjvoLHLe6Abx1RNSHGBCr3q3f'
  ];

  //livenet non-base58
  var nonBase58 = [
    'EN5f6uVd78J#vdmeNBm7W3LgV8ijPHPHBN',
    'ESFpNbj2DS$vRY1CAh4QtMfyqb7ioqTzk6',
    'ETyWKFB8O56IRLH#vRD3h4LeceiXKhLDca',
    'Eb8wTnG#WPjvoLHLe6Abx1RNSHGBCrkqNf'
  ];
  ...
  describe('validation', function() {
    ...
    it('getValidationError detects network mismatchs', function() {
      var error = Address.getValidationError('DAdfKYt51MkXVfpsysGJVcqqExrnzRWU43', 'testnet');
      should.exist(error);
    });

    it('isValid returns true on a valid address', function() {
      var valid = Address.isValid('DAdfKYt51MkXVfpsysGJVcqqExrnzRWU43', 'livenet');
      valid.should.equal(true);
    });

    it('isValid returns false on network mismatch', function() {
      var valid = Address.isValid('DAdfKYt51MkXVfpsysGJVcqqExrnzRWU43', 'testnet');
    ...
    it('addresses with whitespace are validated correctly', function() {
      ...
      should.not.exist(error);
      Address.fromString(ws).toString().should.equal('ESFpNbj2DS7vRY1CAh4QtMfyqb7ioqTzk6');
    });
  ...
  describe('encodings', function() {
    ...
    it('should make this address from a compressed pubkey', function() {
      ...
      address.toString().should.equal('ERqBaVYLy3WErCMKtwPPZXTXQdxkVHhv7Y');
    });
    ...
    it('should make this address from an uncompressed pubkey', function() {
      ...
      a.toString().should.equal('ENTSHHoEjRzsfHYvmwGasPbvdLPGE55Anq');
      var b = new Address(pubkey, 'livenet', 'pubkeyhash');
      b.toString().should.equal('ENTSHHoEjRzsfHYvmwGasPbvdLPGE55Anq');
    });
    ...
    describe('from a script', function() {
      ...
      it('should make this address from a p2pkh output script', function() {
        ...
        a.toString().should.equal('EbU4JZu6gERX1BhCaZgDHinPzvTAmJnG75');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('EbU4JZu6gERX1BhCaZgDHinPzvTAmJnG75');
      });
      ...
      it('should make this address from a p2sh input script', function() {
        ...
        var a = Address.fromScript(s, 'livenet');
        a.toString().should.equal('DLMiyVZ4f25ZrHrE8oWEMj1FzxP19zwUqt');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('DLMiyVZ4f25ZrHrE8oWEMj1FzxP19zwUqt');
      });

      it('returns the same address if the script is a pay to public key hash out', function() {
        var address = 'ENTSHHoEjRzsfHYvmwGasPbvdLPGE55Anq';
      ...
      it('returns the same address if the script is a pay to script hash out', function() {
        var address = 'DEzqrf8gnRkHJc9bbGAytPaxGHnJzR1YSC';
  ...
  describe('#toBuffer', function() {
    ...
    it('3c3fa3d4adcaf8f52d5b1843975e122548269937 corresponds to hash ENeUGsmw8u99wyF948GFwzfC8Udd6RqTbP', function() {
      var address = new Address(str);
  ...
  describe('#inspect', function() {
    it('should output formatted output correctly', function() {
      var address = new Address(str);
      var output = '<Address: ENeUGsmw8u99wyF948GFwzfC8Udd6RqTbP, type: pubkeyhash, network: livenet>';
  ...
  describe('creating a P2SH address from public keys', function() {
    ...
    it('can create an address from a set of public keys', function() {
      ...
      address.toString().should.equal('DKLv19B4SuWm6xFf5w5wp7MkDXEkLTLJgT');
    ...
    it('can create an address from a set of public keys with a nested witness program', function() {
      ...
      address.toString().should.equal('DTGPdJe3EGyDVEaZzvoHEKD7HcewLTyomT');
    });
