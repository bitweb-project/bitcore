...
var dataRawBlockBuffer = fs.readFileSync('test/data/blk00001.dat');
var dataRawBlockBinary = fs.readFileSync('test/data/blk00001.dat', 'binary');
var dataRawId = '00043e9c6bc54d9bd266c3767a83a7b9da435dd7f84e485a2bf2a869be62f1f3';
var data = require('../data/blk00001');
...
describe('BlockHeader', function() {
  ...
  describe('#constructor', function() {
    ...
    it('will throw an error if the argument object hash property doesn\'t match', function() {
      (function() {
        var bh = new BlockHeader({
          hash: '00043e9c6bc54d9bd266c3767a83a7b9da435dd7f84e485a2bf2a869be62f1f3',
          version: version,
          prevHash: prevblockidbuf,
          merkleRoot: merklerootbuf,
          time: time,
  ...
  describe('#fromRawBlock', function() {
    ...
    it('should instantiate from a raw block binary', function() {
      ...
      new BN(x.bits).toString('hex').should.equal('1f1fffff');
    });
  ...
  describe('#getDifficulty', function() {
    it('should get the correct difficulty for block 1', function() {
      var x = BlockHeader.fromRawBlock(dataRawBlockBuffer);
      x.bits.should.equal(0x1f1fffff);
      x.getDifficulty().should.equal(4.76830109616e-7);
    });
    ...
    it('should get the correct difficulty for testnet block 552065', function() {
      ...
      x.getDifficulty().should.equal(86187.62562209023);
    });
