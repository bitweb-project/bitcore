...
var GENESIS_BITS = 0x1f1fffff; // Regtest: 0x207fffff
...
BlockHeader.prototype.getDifficulty = function getDifficulty() {
  ...
  return parseFloat(dDiff.toFixed(18));
}

/**
 * @returns {Buffer} - The little endian hash buffer of the header and hash it with Yespower/YescryptR16 algo.
 */
...
BlockHeader.Constants = {
  ...
  MAX_TIME_OFFSET: 60 * 5, // The max a timestamp can be in the future
